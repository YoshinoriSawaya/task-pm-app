...
[client-requirements.md](../requirements/client-requirements.md)のスコープと[ADR-0001](../adr/0001-vertical-slice-and-hexagonal-architecture.md)のドメインモデル(`Task`エンティティ、`TaskStatus`/`TaskPriority`値オブジェクト)に基づくテーブル設計。
...
- マイグレーション作成: [#13](https://github.com/YoshinoriSawaya/task-pm-app/issues/13)(`deleted_at`を含めてSoftDeletesを有効化する)
