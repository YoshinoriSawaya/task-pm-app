...
| 8 | PMBOKドキュメント整備・振り返り | 完了 | [#40](https://github.com/YoshinoriSawaya/task-pm-app/issues/40) |
...
- フロントエンド実装フェーズ([#22](https://github.com/YoshinoriSawaya/task-pm-app/issues/22)): [#47](https://github.com/YoshinoriSawaya/task-pm-app/issues/47) タスクフォームへの工数入力欄追加(完了。#19で対応済みと判明) / [#48](https://github.com/YoshinoriSawaya/task-pm-app/issues/48) バグ管理画面(完了) / [#49](https://github.com/YoshinoriSawaya/task-pm-app/issues/49) 進捗ダッシュボード画面(完了) **(3件ともShould。CPIが0.96まで改善したことを受けフェーズ6完了後に着手・完了、change-log.md C19)**
