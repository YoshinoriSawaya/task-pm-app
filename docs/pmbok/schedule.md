...
|---|---|---|
| BAC | 16.0h | - |
| PV | 13.5h(環境構築確認0.5h+バックエンド実装3.5h+フロントエンド実装3.5h+統合・E2Eテスト1.0h+リファクタリング・設計比較3.0h+デプロイ2.0hが計画上完了しているべき時点) | 2026-09-06 |
| EV | 13.5h(同上6フェーズがクローズ済み) | 2026-09-06 |
| AC | **14.0h**(自己申告。#12+#17=8.0h、#22=1.0h、#25=1.0h、#29=2.0h、#34=2.0h) | 2026-09-06 |
| CV | **-0.5h**(EV-AC。ほぼ均衡を維持) | 2026-09-06 |
| SV | 0.0h(EV=PVで計画通り) | 2026-09-06 |
| CPI | **0.96**(EV/AC。前回と同水準を維持) | 2026-09-06 |
| SPI | 1.0(フェーズの順序・範囲は計画通り) | 2026-09-06 |
| EAC | **16.6h**(AC+(BAC-EV)/CPI。当初BAC16.0hにほぼ収束したまま) | 2026-09-06 |
| ETC | **2.6h**(EAC-AC。残作業の見積り) | 2026-09-06 |
| VAC | **-0.6h**(BAC-EAC。前回-0.7hからほぼ横ばい) | 2026-09-06 |

**現状の読み方**: フェーズ3完了時点のCPI=0.5→0.83→0.85→0.96→**フェーズ7完了時点0.96**と、CPI改善傾向は5フェーズ連続で維持している。デプロイ(#34)は見積り2.0hに対し実績2.0hでちょうど一致した(ただしIAM/Budgets等の金額セーフティ構築、EC2の障害対応(t3.micro→t3.small)、`php artisan serve`の環境変数バグ切り分け、nginx Basic認証実装までを含む内容としては、実質的に見積りより濃い作業をこなせている)。残りフェーズ(PMBOKドキュメント整備・振り返り)でもこの傾向が続くか継続観測する。
